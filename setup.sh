...
echo "------------------------------------------------------"
echo "⚠️  CRITICAL: You MUST have the following MCPs connected:"
echo " - context7"
echo " - grep_app"
echo " - hacker-news"
echo " - reddit-readonly"
echo " - websearch"
echo ""
echo "⚠️  CRITICAL: You MUST have these Skills installed:"
echo " - multi-search-engine"
echo " - ontology"
echo " - summarize"
echo "------------------------------------------------------"
echo "If any are missing, deep-search will use fallbacks, but"
echo "you will lose native extreme-search capabilities."
