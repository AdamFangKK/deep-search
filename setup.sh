...
echo "------------------------------------------------------"
echo "✅ ENHANCED SkillHub Skills (v2.2+ RECOMMENDED):"
echo " - search-cluster - Multi-provider aggregator (Google, Reddit, Wiki, GNews)"
echo " - news-aggregator-skill - 8-source news (HN, 36Kr, 微博, etc.)"
echo " - academic-deep-research - Academic-grade research methodology"
echo ""
...
echo " - reddit-readonly MCP - Use search-cluster or websearch_exa"
echo " - hacker-news MCP - Use news-aggregator-skill or webfetch"
echo "------------------------------------------------------"
echo "Deep-Search v2.2+ uses ENHANCED data sources:"
echo " - Reddit: search-cluster (SkillHub) PRIMARY, websearch_exa FALLBACK"
